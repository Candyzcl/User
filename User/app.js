...
//   2.实现用户修改功能
//      1.指定表单的提交地址以及请求方式
//      2.接收客户端传递过来的修改信息 找到用户 将用户信息改为最新的
...
// User.create({ name: '李四', age: 20, hobbies: ['吃饭', '打豆豆'], email: 'lisi@itcast.cn', password: '12345' })
// User.create({ name: '王五', age: 50, hobbies: ['吃饭', '打游戏'], email: 'wangwu@itcast.cn', password: '12345' })
